...
** TODO [#A] Equality for procedures?
** TODO [#A] Error messages: use Writer class
** TODO [#A] Wrong type generic error
...
** TODO [#C] Correct error messages (Long -> Integer? etc.)
** DONE Nil value
