...
This is my [first] attempt to implement Scheme R5RS (http://www.schemers.org/Documents/Standards/R5RS/) in Java.
...
See TODO list below for things implementated.
...
** TODO Performance [/]
*** TODO Predicates (pair? promise? etc.)
*** TODO Cache environment lookup
*** TODO Evaluator.evlis()
