...
** TODO [#A] Tail-call elimination
*** TODO (lambda <formals> <definition>* <expression>* <tail expression>)
*** DONE (if <expression> <tail expression> <tail expression>)
CLOSED: [2016-08-24 Wed 08:02]
*** DONE (if <expression> <tail expression>)
CLOSED: [2016-08-24 Wed 08:02]
*** TODO (cond <cond clause>+) (cond <cond clause>* (else <tail sequence>))
*** TODO (case <expression> <case clause>+) (case <expression> <case clause>* (else <tail sequence>))
*** DONE (and <expression>* <tail expression>)
CLOSED: [2016-08-24 Wed 08:09]
*** DONE (or <expression>* <tail expression>)
CLOSED: [2016-08-24 Wed 08:09]
*** TODO (let (<binding spec>*) <tail body>)
*** TODO (let <variable> (<binding spec>*) <tail body>)
*** TODO (let* (<binding spec>*) <tail body>)
*** TODO (letrec (<binding spec>*) <tail body>)
...
*** TODO (do (<iteration spec>*) (<test> <tail sequence>) <expression>*)
*** where
...
** TODO [#C] Read multiple forms on one line (not the first one only)
