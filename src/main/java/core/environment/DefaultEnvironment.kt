...
class DefaultEnvironment : Environment(null) {
    ...
    companion object {
        ...
        private val STANDARD_PROCEDURES = arrayOf(
                ...
                Cast(),
                ClassProc(),
                object : ClassProc() { override fun getName(): String { return "class-of" } },
                ErrorProc(),
                Pst(),
                Eval(),
                RandomProc(),
                HashCode(),
                object : HashCode() { override fun getName(): String { return "hash" } },
                ToString(), object : ToString() { override fun getName(): String { return "str" } },
                Name(),
                Identity(),
                Num(),
                Sleep(),
                ...
                Log(),
                Modulo(),
                object : Modulo() { override fun getName(): String { return "mod" } },
                Remainder(),
                Quotient(),
                object : Quotient() { override fun getName(): String { return "quot" } },
                Round(),
                Floor(),
                Ceiling(),
                Truncate(),
                ...
                StringProc(),
                Substring(),
                object : Substring() { override fun getName(): String { return "subs" } },
                StringAppend(),
                StringFill(),
                MakeString(),
                ListToString(),
                ...
                /* IO */
                Display(),
                object : Display() { override fun getName(): String { return "print" } },
                Println(),
                Newline(),
                Load(),
                Read(),
                ...
                SymbolToString(),
                StringToSymbol(),
                object : StringToSymbol() { override fun getName(): String { return "symbol" } },
                ...
                Nth(),
                Sort(),
                object : Count() { override fun getName(): String { return "length" } },
                Conj(),
                Empty(),
                Range(),
                First(),
                Second(),
                Next(),
                object : Next() { override fun getName(): String { return "rest" } },
                RandNth(),
