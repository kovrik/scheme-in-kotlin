...
public final class Predicate extends AFn {
  ...
  public static final Predicate IS_PROMISE = new Predicate("promise?", o -> o instanceof CompletableFuture || Delay.class == o.getClass());
  public static final Predicate IS_FUTURE = new Predicate("future?", o -> o instanceof java.util.concurrent.Future && !(o instanceof Delay) && !(o instanceof Promise));
  ...
  public static final Predicate IS_COLL = new Predicate("coll?", o -> o instanceof Collection || o instanceof Map);
  ...
  public static final Predicate IS_INTEGER = new Predicate("integer?", Utils.INSTANCE::isInteger);
  public static final Predicate IS_RATIONAL = new Predicate("rational?", Utils.INSTANCE::isRational);
  public static final Predicate IS_RATIO = new Predicate("ratio?", o -> o instanceof BigRatio);
  public static final Predicate IS_REAL = new Predicate("real?", Utils.INSTANCE::isReal);
  public static final Predicate IS_COMPLEX = new Predicate("complex?", o -> o instanceof Number);
  public static final Predicate IS_ZERO = new Predicate("zero?", o -> assertClass("zero?", o, Number.class) && Utils.INSTANCE.isZero(o));
  public static final Predicate IS_POSITIVE = new Predicate("positive?", o -> assertClass("positive?", o, Type.Real.class) && Utils.INSTANCE.isPositive(o));
  public static final Predicate IS_POS = new Predicate("pos?", o -> assertClass("pos?", o, Type.Real.class) && Utils.INSTANCE.isPositive(o));
  public static final Predicate IS_NEGATIVE = new Predicate("negative?", o -> assertClass("negative?", o, Type.Real.class) && Utils.INSTANCE.isNegative(o));
  public static final Predicate IS_NEG = new Predicate("neg?", o -> assertClass("neg?", o, Type.Real.class) && Utils.INSTANCE.isNegative(o));
  public static final Predicate IS_EXACT = new Predicate("exact?", o -> assertClass("exact?", o, Number.class) && Utils.INSTANCE.isExact(o));
  public static final Predicate IS_INEXACT = new Predicate("inexact?", o -> assertClass("inexact?", o, Number.class) && Utils.INSTANCE.isInexact(o));
  ...
  public static final Predicate IS_EVEN = new Predicate("even?", o -> assertClass("even?", o, Integer.class) && Utils.INSTANCE.isZero(Remainder.apply((Number)o, 2L)));
  public static final Predicate IS_ODD = new Predicate("odd?", o -> assertClass("odd?", o, Integer.class) && !Utils.INSTANCE.isZero(Remainder.apply((Number)o, 2L)));
