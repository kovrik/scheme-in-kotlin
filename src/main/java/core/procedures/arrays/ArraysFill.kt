...
object ArraysFill {
    ...
    class BooleansFill : AFn<Any?, BooleanArray>(name = "booleans-fill!", isPure = true, arity = Exactly(2),
    ...
    class BytesFill : AFn<Any?, ByteArray>(name = "bytes-fill!", isPure = true, arity = Exactly(2),
    ...
    class ShortsFill : AFn<Any?, ShortArray>(name = "shorts-fill!", isPure = true, arity = Exactly(2),
    ...
    class CharsFill : AFn<Any?, CharArray>(name = "chars-fill!", isPure = true, arity = Exactly(2),
    ...
    class IntsFill : AFn<Any?, IntArray>(name = "ints-fill!", isPure = true, arity = Exactly(2),
    ...
    class LongsFill : AFn<Any?, LongArray>(name = "longs-fill!", isPure = true, arity = Exactly(2),
    ...
    class FloatsFill : AFn<Any?, FloatArray>(name = "floats-fill!", isPure = true, arity = Exactly(2),
    ...
    class DoublesFill : AFn<Any?, DoubleArray>(name = "doubles-fill!", isPure = true, arity = Exactly(2),
    ...
    class ObjectsFill : AFn<Any?, Array<*>>(name = "objects-fill!", isPure = true, arity = Exactly(2),
