...
public class RosettaCodeTest extends AbstractTest {
  ...
  public void testIntegerRoots() {
    ...
    assertEquals(new BigInteger("125992104989487316476"),
                 eval("(root 3 (* 2 (expt 1000 20)))", tempEnv));

    assertEquals(new BigInteger("125992104989487316476721060727822835057025146470150798008197511215529967651395948372939656243625509415431025603561566525939902404061373722845911030426935524696064261662500097747452656548030686718540551"),
                 eval("(root 3 (* 2 (expt 1000 200)))", tempEnv));

    // TODO Optimize: Slooooow (~16s and ~1m 40s each)!
//     assertEquals(new BigInteger(""),
//                  eval("(root 3 (* 2 (expt 1000 1000)))", tempEnv));

    /*
     * Quotient.apply()            | 42.6s
     * NumericalComparison.apply() | 36s
     */
//    assertEquals(new BigInteger(""),
//                 eval("(root 3 (* 2 (expt 1000 2000)))", tempEnv));
  ...
  public void testHaversineFormula() {
    ...
    eval("(define (deg-to-rad d m s) " +
         "  (* (/ pi 180) (+ d (/ m 60) (/ s 3600))))", env);
