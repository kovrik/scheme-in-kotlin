...
public class NumberTest extends AbstractTest {
  ...
  public void testEvalNumbers() {
    ...
    assertEquals(BigRatio.Companion.valueOf("101", "10"), eval("#e#d10.1", env));
  ...
  public void testEvalMath() {
    ...
    assertEquals(BigRatio.Companion.valueOf("1", "10"), eval("(/ 10)", env));
    assertEquals(BigRatio.Companion.valueOf("13", "4"), eval("(/ 13 4)", env));
    ...
    assertEquals(BigRatio.Companion.valueOf("9999", "3332"), eval("(/ 3332/9999)", env));
    assertEquals(BigRatio.Companion.valueOf("9999", "3332"), eval("(/ 1 3332/9999)", env));
    ...
    assertEquals(BigRatio.Companion.valueOf("1", "100"), eval("(/ 1 10 10)", env));
    assertEquals(BigRatio.Companion.valueOf("26", "5"), eval("(+ 1/5 (short 5))", env));
    assertEquals(BigRatio.Companion.valueOf("-71", "12"), eval("(- 1/12 (short 6))", env));
    assertEquals(BigRatio.Companion.valueOf("5", "23"), eval("(* 1/23 (short 5))", env));
    assertEquals(BigRatio.Companion.valueOf("1", "115"), eval("(/ 1/23 (short 5))", env));
  }
  ...
  public void testEvalLCM() {
    ...
    assertEquals(new BigInteger(big), eval(String.format("(lcm %s 9)", big), env));

    assertEquals(new BigInteger("9066296685449845496062520942090242184133343279738102243137866423949"),
  ...
  public void testBigDecimal() {
    ...
    assertEquals(new BigInteger(big0), eval(big0, env));

    BigInteger big1 = new BigInteger("46253220748483971668312221557921994865355615937726643119142534763573384386717010179" +
    ...
    assertEquals(new BigInteger(big0), eval(String.format("(* (/ %s 10) 10)", big0), env));
    assertEquals(new BigInteger(big0).multiply(new BigInteger("2")), eval(String.format("(+ %s %s)", big0, big0), env));
    assertEquals(new BigInteger(big0).multiply(new BigInteger("2")).subtract(new BigInteger(big0)),
    ...
    assertEquals(new BigDecimal(big0).add(BigDecimal.ONE), eval(String.format("(ceiling (+ 0.2 %s))", big0),  env));

    assertEquals(new BigInteger(big0), eval(String.format("(abs -%s)", big0),  env));
    assertEquals(new BigInteger(big0).add(BigInteger.ONE), eval(String.format("(max (+ 1 %s) %s)", big0, big0),  env));

    assertEquals(new BigInteger(big0), eval(String.format("(min (+ 1 %s) %s)", big0, big0),  env));
    ...
    assertEquals(new BigInteger(quotientResult1), eval(String.format("(quotient %s 2)", big2), env));
    ...
    assertEquals(new BigInteger("-99999999999999999999999999999999999999999999999999"),
  ...
  public void testStringToNumber() {
    ...
    assertEquals(new BigInteger("26623333280885243903"), eval("(string->number \"bbbbbbbbbbbbbbbbbb\" 12)", env));
    assertEquals(new BigInteger("26623333280885243903"), eval("(string->number \"BBBBBBBBBBBBBBBBBB\" 12)", env));
    assertEquals(new BigInteger("110573323209400121422731899656355381011962890624"), eval("(string->number \"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee\" 15)", env));
    assertEquals(new BigDecimal("110573323209400121422731899656355381011962890624.0"), eval("(string->number \"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.0\" 15)", env));
    assertEquals(FALSE, eval("(string->number \"eeef\" 15)", env));
    assertEquals(85L, eval("(string->number \"1010101\" 2)", env));
    assertEquals(new BigInteger("289264344747772786367397236066475587972918828808734345141483382767615"), eval("(string->number \"#xababaabababababababababababababafffffffffffffffffffffffff\")", env));
    assertEquals(new BigDecimal("289264344747772786367397236066475587972918828808734345141483382767615.0"), eval("(string->number \"#xababaabababababababababababababafffffffffffffffffffffffff.0\")", env));
  ...
  public void testDenominator() {
    ...
    assertEquals(BigRatio.Companion
  ...
  public void testFindBetween() {
    ...
    assertEquals(BigRatio.Companion.valueOf("1", "3"), eval("(find-between 3332/9999 3334/9999)", env));
  }

  @Test
  public void testRationalize() {
    assertEquals(0L, eval("(rationalize 1/3 1/3)", env));
    assertEquals(BigRatio.Companion.valueOf("1", "3"), eval("(rationalize 1/3 1/9999)", env));
