...
class WriterTest {
    ...
    fun testWriteSymbol() {
        ...
        assertEquals("#<procedure>", Writer.write(Procedure("", emptyArray(), Any(), Environment(0, null), true)))
        assertEquals("#<procedure:test>", Writer.write(Procedure("test", emptyArray(), Any(), Environment(0, null), true)))
    }
