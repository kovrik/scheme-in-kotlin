...
class ConsTest {
    ...
    fun testIsNil() {
        ...
        assertEquals(FALSE, Companion.IS_NULL.apply1(list(1, 2, 3)))
        assertEquals(FALSE, Companion.IS_NULL.apply1(1))
        assertEquals(FALSE, Companion.IS_NULL.apply1("test"))
    }
    ...
    @Test
    fun testIsList() {
        assertEquals(TRUE, Companion.IS_LIST.apply1(EMPTY))
        assertEquals(TRUE, Companion.IS_LIST.apply1(list<Any>()))
        assertEquals(TRUE, Companion.IS_LIST.apply1(list(1)))
        assertEquals(TRUE, Companion.IS_LIST.apply1(list(1, 2)))
        assertEquals(TRUE, Companion.IS_LIST.apply1(list(1, 2, 3)))
        assertEquals(TRUE, Companion.IS_LIST.apply1(list(1, 2, 3, 4)))
        ...
        assertEquals(TRUE, Companion.IS_LIST.apply1(ConsProc.cons(1, ConsProc.cons(2, ConsProc.cons(3, list(1, 2, 3))))))
    }
}
