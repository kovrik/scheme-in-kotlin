...
public class TrigonometryTest extends AbstractTest {
  ...
  public void testSin() {
    ...
    assertEquals(new BigComplex(new BigDecimal("1.2984575814159773"), new BigDecimal("0.6349639147847361")), eval("(sin 1+1i)", env));
    assertEquals(new BigComplex(new BigDecimal("-8.471645454300148"), new BigDecimal("-5.412680923178193")), eval("(sin -1-3i)", env));
//    assertEquals(-0.1285197485957309, eval("(sin 99999999999999999999999999999999999999999999999999999999999999)", env));
  ...
  public void testCos() {
    ...
    assertEquals(new BigComplex(new BigDecimal("0.8337300251311492"), new BigDecimal("-0.9888977057628651")), eval("(cos 1+1i)", env));
    assertEquals(new BigComplex(new BigDecimal("5.439580991019764"), new BigDecimal("-8.429751080849945")), eval("(cos -1-3i)", env));
  ...
  public void testTan() {
    ...
    assertEquals(new BigComplex(new BigDecimal("0.2717525853195118"), new BigDecimal("1.083923327338694")), eval("(tan 1+1i)", env));
    assertEquals(new BigComplex(new BigDecimal("-0.0045171372766583"), new BigDecimal("-1.002054988245812")), eval("(tan -1-3i)", env));
  ...
  public void testSinh() {
    ...
    assertEquals(new BigComplex(new BigDecimal("0.6349639147847361"), new BigDecimal("1.2984575814159773")), eval("(sinh 1+1i)", env));
    assertEquals(new BigComplex(new BigDecimal("1.1634403637032504"), new BigDecimal("-0.21775955162215221")), eval("(sinh -1-3i)", env));
  ...
  public void testCosh() {
    ...
    assertEquals(new BigComplex(new BigDecimal("0.8337300251311492"), new BigDecimal("0.9888977057628651")), eval("(cosh 1+1i)", env));
    assertEquals(new BigComplex(new BigDecimal("-1.5276382501165435"), new BigDecimal("0.1658444019189788")), eval("(cosh -1-3i)", env));
  ...
  public void testTanh() {
    ...
    assertEquals(new BigComplex(new BigDecimal("1.083923327338694"), new BigDecimal("0.2717525853195118")), eval("(tanh 1+1i)", env));
    assertEquals(new BigComplex(new BigDecimal("-0.7680176472869111"), new BigDecimal("0.05916853956605073")), eval("(tanh -1-3i)", env));
  ...
  public void testAsin() {
    ...
    assertEquals(new BigComplex(new BigDecimal("1.5707963267948966"), new BigDecimal("-1.8115262724608532")), eval("(asin pi)", env));
    assertEquals(new BigComplex(new BigDecimal("1.5707963267948966"), new BigDecimal("-1.0232274785475506")), eval("(asin (/ pi 2))", env));
    assertEquals(new BigComplex(new BigDecimal("1.5707963267948966"), new BigDecimal("-1.4750447812414251")), eval("(asin 2.3)", env));
    assertEquals(new BigComplex(new BigDecimal("0.6662394324925154"), new BigDecimal("1.0612750619050357")), eval("(asin 1+1i)", env));
    assertEquals(new BigComplex(new BigDecimal("-0.3076036495307112"), new BigDecimal("-1.8641615441578825")), eval("(asin -1-3i)", env));
  ...
  public void testAcos() {
    ...
    assertEquals(new BigComplex(new BigDecimal("0"), new BigDecimal("1.8115262724608532")), eval("(acos pi)", env));
    assertEquals(new BigComplex(new BigDecimal("0"), new BigDecimal("1.4750447812414251")), eval("(acos 2.3)", env));
    assertEquals(new BigComplex(new BigDecimal("0.9045568943023813"), new BigDecimal("-1.0612750619050357")), eval("(acos 1+1i)", env));
    assertEquals(new BigComplex(new BigDecimal("1.8783999763256078"), new BigDecimal("1.8641615441578825")), eval("(acos -1-3i)", env));
  ...
  public void testAtan() {
    ...
    assertEquals(new BigComplex(new BigDecimal("1.0172219678978514"), new BigDecimal("0.4023594781085251")), eval("(atan 1+1i)", env));
    assertEquals(new BigComplex(new BigDecimal("-1.4614618538579256"), new BigDecimal("-0.305943857905529")), eval("(atan -1-3i)", env));
