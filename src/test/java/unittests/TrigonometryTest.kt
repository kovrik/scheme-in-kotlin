...
class TrigonometryTest : AbstractTest() {
    ...
    fun testSin() {
        ...
        assertEquals(Complex(BigDecimal("1.2984575814159773"), BigDecimal("0.6349639147847361")), eval("(sin 1+1i)", env))
        assertEquals(Complex(BigDecimal("-8.471645454300148"), BigDecimal("-5.412680923178193")), eval("(sin -1-3i)", env))
    ...
    fun testCos() {
        ...
        assertEquals(Complex(BigDecimal("0.8337300251311492"), BigDecimal("-0.9888977057628651")), eval("(cos 1+1i)", env))
        assertEquals(Complex(BigDecimal("5.439580991019764"), BigDecimal("-8.429751080849945")), eval("(cos -1-3i)", env))
    ...
    fun testTan() {
        ...
        assertEquals(Complex(BigDecimal("0.2717525853195118"), BigDecimal("1.083923327338694")), eval("(tan 1+1i)", env))
        assertEquals(Complex(BigDecimal("-0.0045171372766583"), BigDecimal("-1.002054988245812")), eval("(tan -1-3i)", env))
    ...
    fun testSinh() {
        ...
        assertEquals(Complex(BigDecimal("0.6349639147847361"), BigDecimal("1.2984575814159773")), eval("(sinh 1+1i)", env))
        assertEquals(Complex(BigDecimal("1.1634403637032504"), BigDecimal("-0.21775955162215221")), eval("(sinh -1-3i)", env))
    ...
    fun testCosh() {
        ...
        assertEquals(Complex(BigDecimal("0.8337300251311492"), BigDecimal("0.9888977057628651")), eval("(cosh 1+1i)", env))
        assertEquals(Complex(BigDecimal("-1.5276382501165435"), BigDecimal("0.1658444019189788")), eval("(cosh -1-3i)", env))
    ...
    fun testTanh() {
        ...
        assertEquals(Complex(BigDecimal("1.083923327338694"), BigDecimal("0.2717525853195118")), eval("(tanh 1+1i)", env))
        assertEquals(Complex(BigDecimal("-0.7680176472869111"), BigDecimal("0.05916853956605073")), eval("(tanh -1-3i)", env))
    ...
    fun testAsin() {
        ...
        assertEquals(Complex(BigDecimal("1.5707963267948966"), BigDecimal("-1.8115262724608532")), eval("(asin pi)", env))
        assertEquals(Complex(BigDecimal("1.5707963267948966"), BigDecimal("-1.0232274785475506")), eval("(asin (/ pi 2))", env))
        assertEquals(Complex(BigDecimal("1.5707963267948966"), BigDecimal("-1.4750447812414251")), eval("(asin 2.3)", env))
        assertEquals(Complex(BigDecimal("0.6662394324925154"), BigDecimal("1.0612750619050357")), eval("(asin 1+1i)", env))
        assertEquals(Complex(BigDecimal("-0.3076036495307112"), BigDecimal("-1.8641615441578825")), eval("(asin -1-3i)", env))
    ...
    fun testAcos() {
        ...
        assertEquals(Complex(BigDecimal("0"), BigDecimal("1.8115262724608532")), eval("(acos pi)", env))
        assertEquals(Complex(BigDecimal("0"), BigDecimal("1.4750447812414251")), eval("(acos 2.3)", env))
        assertEquals(Complex(BigDecimal("0.9045568943023813"), BigDecimal("-1.0612750619050357")), eval("(acos 1+1i)", env))
        assertEquals(Complex(BigDecimal("1.8783999763256078"), BigDecimal("1.8641615441578825")), eval("(acos -1-3i)", env))
    ...
    fun testAtan() {
        ...
        assertEquals(Complex(BigDecimal("1.0172219678978514"), BigDecimal("0.4023594781085251")), eval("(atan 1+1i)", env))
        assertEquals(Complex(BigDecimal("-1.4614618538579256"), BigDecimal("-0.305943857905529")), eval("(atan -1-3i)", env))
