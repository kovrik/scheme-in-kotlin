...
class EqvTest : AbstractTest() {

    @Test
    fun testEqv() {
        val trues = arrayOf(
                "(let ((x (vector 'a))) (eqv? x x))", "(eqv? car car)", "(let ((x (lambda () 1))) (eqv? x x))",
                "(eqv? 'quote 'quote) #t)", "(eqv? '2 '2)", "(eqv? '2 2)", "(eqv? '#\\a #\\a)", "(eqv? '#f #f)",
                "(eqv? '#f '#f)", "(eqv? #\\a #\\a)", "(eqv? #\\space #\\space)", "(eqv? #\\  #\\space)",
        ...
        val falses = arrayOf(
                ...
                "(eqv? '(1) '(1))", "(eqv? '(#f) '(#f))", "(eqv? #\\a #\\b)", "(eqv? #f #t)", "(eqv? 'a 'b)",
                "(eqv? '(a) '(b))", "(eqv? (cons 'a 'b) (cons 'a 'b))", "(eqv? \"abc\" \"cba\")", "(eqv? (string #\\h #\\i) (string #\\h #\\i))",
